...
切到右侧“在线匹配”时，左侧素材列表会换成本地歌词预览，右侧完整显示 LRCLIB 在线歌词；可从歌曲和候选下拉框选择内容，单独采用一侧，或交叉组合“本地时间轴 + 在线文字”“在线时间轴 + 本地文字”。底部播放器播放本地素材，并按同一播放位置实时高亮、滚动两侧歌词；双击任一侧可暂停并修改。参见 [在线歌词匹配与 AI 校准指南](docs/在线歌词匹配与AI校准指南.md)。
