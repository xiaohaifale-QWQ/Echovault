...
切到右侧“在线匹配”时，主窗口左侧会换成完整歌词核对区：左半栏是本地识别歌词，右半栏是自动繁转简后的在线歌词，下方是本地素材播放器。右侧顶部可选择“搜索歌词”“搜索封面”或“本地封面”，共用结果区会按当前操作显示歌词表或封面缩略图；点击封面后确认即可写入音频标签，不再需要额外的写入按钮。素材列表会在歌曲名称旁显示内嵌封面缩略图。参见 [在线歌词匹配与 AI 校准指南](docs/在线歌词匹配与AI校准指南.md)。
...
打开右侧“人声分离”，从统一模型库安装 HTDemucs 后即可处理当前音乐或视频素材。处理设置
...
选择素材后打开右侧“音频编辑”。首页是工具宫格，点击任一功能会进入独立参数页：
