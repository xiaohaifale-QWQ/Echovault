...
| 歌词与标签 | 按“在线歌词与封面、本地识别编辑、歌词核对”三个独立工作流组织；支持 LRCLIB 歌词、MusicBrainz 封面、同步播放器、音频标签编辑与 AI 校准。 |
...
切到左侧“歌词与标签”后，默认先进入“在线歌词与封面”：点击“一键搜索歌词与封面”，歌词和封面会并行请求；左侧显示在线同步歌词及随播放器自动滚动的当前行，右侧同时显示封面候选和标题、歌手、专辑、年份、轨道号标签编辑器。相同查询缓存 10 分钟，封面缩略图并发载入。“本地识别编辑”负责离线识别、编辑与翻译，“歌词核对”则提供本地/在线双栏对照、试听、合并和 AI 校准。素材列表会在歌曲名称旁显示内嵌封面缩略图。参见 [在线歌词匹配与 AI 校准指南](docs/在线歌词匹配与AI校准指南.md)。
...
- 合成与输出：带静音/独奏/音量的轨道时间线、左右声道合成、音轨提取、音乐标签表单。
