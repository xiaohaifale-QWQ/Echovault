...
切到右侧“在线匹配”时，主窗口左侧会换成完整歌词核对区：左半栏是本地识别歌词，右半栏是自动繁转简后的在线歌词，下方是本地素材播放器。右侧除歌词搜索、直接应用、交叉合并和 AI 校准外，还可从 MusicBrainz/Cover Art Archive 搜索封面，或选择本地 JPEG/PNG 写入音频标签。素材列表会在歌曲名称旁显示内嵌封面缩略图。参见 [在线歌词匹配与 AI 校准指南](docs/在线歌词匹配与AI校准指南.md)。
