...
from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QTableWidget, QTableWidgetItem, QHeaderView,
    QLabel, QLineEdit, QHBoxLayout, QAbstractItemView, QComboBox, QMessageBox, QPushButton)
...
class SongListPanel(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.btn_batch.setStyleSheet("QPushButton{background:#1976D2;color:white;border-radius:3px;padding:2px 8px;font-size:12px}QPushButton:hover{background:#1565C0}")
        self.btn_batch.clicked.connect(self.batch_transcribe.emit)
