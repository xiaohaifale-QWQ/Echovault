...
“歌词与标签”包含“在线歌词与封面、本地识别编辑、歌词核对”三个功能。“在线歌词与封面”排在第一位，顶部搜索卡可一键并行搜索 LRCLIB 歌词和 MusicBrainz/Cover Art Archive 封面；左侧依次为候选表、歌词正文和同步播放器，右侧通过“封面候选 / 音频标签”页签切换，可编辑标题、歌手、专辑、年份和轨道号；相同搜索缓存 10 分钟。下载同步歌词会先备份已有 LRC；独立的歌词核对页保留本地时间戳，只校准歌词文字。
