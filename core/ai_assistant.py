...
常用 CLI：list、info、transcribe、lyrics、config、model、gpu、sync、rename、mark、serve、doctor，以及 library、video、ai。所有配置可使用 config set；AI 对话可使用 ai chat；歌词翻译可使用 lyrics translate。
